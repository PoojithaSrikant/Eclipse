...
public class Step_defintion {
	WebDriver wd;

	@Given("Use should be in the login page")
	public void use_should_be_in_the_login_page() throws InterruptedException {
	...
	public void i_should_get_the_title(String string) {
	   Assert.assertEquals(wd.getTitle(), true);
	}
